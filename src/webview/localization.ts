...
const messages = {
  en: {
    ...
    tocOverflow: 'TOC long headings', tocOverflowEllipsis: 'Single line with ellipsis', tocOverflowWrap: 'Wrap onto multiple lines',
    ...
    previousMatch: 'Previous match', nextMatch: 'Next match', closeFind: 'Close find', editHeading: 'Edit heading in source', editSelectionInSource: 'Edit selected text in source',
  ...
  'zh-CN': {
    ...
    tocOverflow: '目录长标题显示', tocOverflowEllipsis: '单行省略', tocOverflowWrap: '自动换行',
    ...
    previousMatch: '上一个匹配项', nextMatch: '下一个匹配项', closeFind: '关闭查找', editHeading: '在源码中编辑标题', editSelectionInSource: '在源码中编辑所选文本',
